...
public class GoogleService : MonoBehaviour {
	...
	//private const string API_KEY = "AIzaSyB46oMdteOfODHsYZd8b_qwpOHLVQ8Xn-E";
	//private const string SEARCH_ENGINE_ID = "011818386419264959986:s6o6uvyilvk";
	private const string API_KEY = "AIzaSyChVfEfNQi1vS_dWap0hJEKC4s-k22S4JU";
	private const string SEARCH_ENGINE_ID = "011818386419264959986:vx6rnmhdtrw";
